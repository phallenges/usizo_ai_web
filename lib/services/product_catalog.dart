...
class ProductCatalog {
  ...
  static const fallback = <Product>[
    Product(
      ...
      priceCents: 3100,
      description:
          'Sun-dried Moringa oleifera leaves. Rich in vitamins and minerals.',
    ...
    Product(
      ...
      priceCents: 2500,
      description:
          'Lippia javanica loose-leaf tea. Traditionally used for colds and flu.',
      category: 'Herbal tea',
    ...
    Product(
      ...
      priceCents: 5500,
      description:
          'Azadirachta indica capsules for skin and immune support.',
      category: 'Capsules',
    ...
    Product(
      ...
      priceCents: 4200,
      description:
          'Fresh-ground ginger and turmeric blend. Anti-inflammatory properties.',
    ...
    Product(
      ...
      priceCents: 3800,
      description:
          'Pure aloe vera gel for skin soothing and wound healing.',
      category: 'Topical',
    ...
    Product(
      ...
      priceCents: 2800,
      description:
          'Artemisia afra dried herb bundle. Traditional respiratory remedy.',
      category: 'Herbal remedy',
